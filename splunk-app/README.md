...
Download [`releases/splunk_app_oci-2.2.0.spl`](releases/splunk_app_oci-2.2.0.spl)
(verify with [`.sha256`](releases/splunk_app_oci-2.2.0.spl.sha256)), then in Splunk:
...
```bash
$SPLUNK_HOME/bin/splunk install app splunk_app_oci-2.2.0.spl -update 1
